...
const EventsProfile = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white min-w-fit w-[40vw] flex rounded-xl h-96 shadow-md hover:scale-105 hover:shadow-lg hover:shadow-light-yellow transition duration-300 ease-in-out">
        <img src={image} alt={title} className="h-full w-[50%] rounded-l-xl object-cover" />

        <div className="flex-col p-6">
          <div className="mb-4">
            <h1 className="text-bright-orange font-ubuntu font-bold text-3xl">{title}</h1>
          ...
          <div className="text-yellow">
            <p className="text-black ubuntu-light-italic">{address}</p>
          </div>
        </div>
      </div>
    </main>
