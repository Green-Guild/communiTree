...
import { capitalizeWords, getLocationByZip } from "../utils";
...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const locationFilter = async () => {
      setLocation(capitalizeWords(await getLocationByZip(currentUser.zipcode)));
    };

    locationFilter();
    fetchUserContributions();
  }, [contributionType, currentUser]);
      ...
      <div className="flex flex-col items-center">
        {!editMode && (
          <img
            ...
            alt="Profile"
            className="rounded-full mt-12 border-4 border-yellow w-32 h-w-32 shadow-md mb-4"
          />
        )}
        <div>
          ...
          {editMode ? (
            ...
            <div className="text-center">
              ...
              <p className="text-white ubuntu-light-italic">{location}</p>
            </div>
          )}
        </div>
      </div>
