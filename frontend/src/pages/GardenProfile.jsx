...
const GardenProfile = () => {
  ...
  return (
    <main className="bg-yellow h-screen p-16 flex items-center justify-center align-middle">
      ...
      <div className="bg-white min-w-fit w-[40vw] flex rounded-xl h-96 shadow-md hover:scale-10 hover:shadow-lg hover:shadow-light-yellow transition duration-300 ease-in-out">
        <img src={image} alt={name} className=" h-full w-[50%] rounded-l-xl object-cover" />

        <div className="flex-col p-6">
          <div className=" mb-4">
            <h1 className="text-bright-orange font-ubuntu font-bold text-3xl">{name}</h1>
            <p className="text-yellow font-ubuntu ubuntu-light-italic">{location}</p>
          </div>
          <div className="text-yellow">
            {/* <h2 className="text-yellow text-xl font-semibold">About</h2> */}
            <p className="text-black">{description} text will go here</p>
          </div>
        </div>
      </div>
